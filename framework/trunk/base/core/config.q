...
// DOCUMENTATION
//Qpad located here : C:\Users\owner\Documents\KDB
//\l C:\kdb\kat_framework\trunk\base\core\config.q
...
/  @returns (Dict) The alias <-> underling variable mapping
.config.loadVarMap:{
...
/  @returns () The object stored within variable or alias
/  @throws VariableNotSetException If the underlying variable does not exist
.config.get:{[cVar]
    ...
    / Should be safe be here. No try/catch required.
    :get actualVar;
 };
...
/ Loads the specified CSV file with the specified format, removing any blank lines or
