...
/q tick.q [source of the historical database] [destination path] [-p 5010] [-o h]
/q tick.q SRC [DST] [-p 5010] [-o h]
/Actually try to start the Feedhandler should be \l tick/
/The full command is: system"\l tick/sym.q"
system"l tick/",(src:first .z.x,enlist"sym"),".q"

/Set the port to 5010
if[not system"p";system"p 5010"]

\l tick/u.q
/Switch to u workspace
\d .u

/Open Log File and start writing data on it
...
tick:{init[];
	  ...
	  /Apply the grouped attribute before pushing to Real Time Database
	  @[;`sym;`g#]each t;
	  d::.z.D;
	  if[l::count y;L::`$":",y,"/",x,10#".";
	  l::ld d]};

/End of Day Job to close the handle to the tickerplant Log
endofday:{end d;
		  d+:1;
